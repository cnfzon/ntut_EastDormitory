    ...
    <Layout title="網站問題回報">
      ...
      <section className="content-section">
        <div className="max-w-3xl mx-auto">
          <div className="card p-8 border border-gray-100 rounded-xl">
            ...
            <div className="text-center">
              <a
                ...
                className="btn btn-primary inline-block py-3 px-8 text-lg rounded-lg hover:scale-105 transition-transform"
              >
                前往填寫表單
              </a>
            </div>
